...
def standardconf():
  ...
  [defaultcss]
  <link rel="stylesheet" href="../dist/jemdoc.css" type="text/css" />
  [windowtitle]
  # used in header for window title.
  <title>|</title>
	<link rel="canonical" href="http://jemdoc.jaboc.net/dist/jemdoc.html" />
  [fwtitlestart]
  <div id="fwtitle">
  [fwtitleend]
  </div>
  ...
  [menuitem]
  <div class="menu-item"><a href="/">|2</a></div>
  [specificcss]
  <link rel="stylesheet" href="/" type="text/css" />
  [specificjs]
  <script src="|.js" type="text/javascript"></script>
  [currentmenuitem]
  <div class="menu-item"><a href="/" class="current">|2</a></div>
  [nomenu]
...
def replaceequations(b, f):
  ...
  for (r, wl) in rs:
    ...
    while m:
      ...
      if wl:
        b = b[:m.start()] + \
            '{{\n<div class="eqwl"><img class="eqwl" src="/" alt="%s" />\n<br /></div>}}' % (fullfn, eqtext) + b[m.end():]
      else:
        b = b[:m.start()] + \
          '{{<img class="eq" src="/" alt="%s" style="vertical-align: -%dpx" />}}' % (fullfn, eqtext, offset) + b[m.end():]
    ...
    # look for blocks.
      ...
      if infoblock:
        ...
        if len(g) in (0, 1): # info block.
          ...
          if g[6]:
            out(f.outf, '<a href="/">' % g[6])
          out(f.outf, '<img src="/"' % g[2])
