...
entry_2 = Entry(base)  # Changed from entry_02 to entry_2
entry_2.place(x=240, y=180)

labl_3 = Label(base, text="Gender", width=20, font=("bold", 10))
labl_3.place(x=70, y=230)

varlbl = IntVar()  # Changed from varblbl to varlbl
Radiobutton(base, text="Male", padx=5, variable=varlbl, value=1).place(x=235, y=230)
Radiobutton(base, text="Female", padx=20, variable=varlbl, value=2).place(x=290, y=230)

labl_4 = Label(base, text="Age:", width=20, font=("bold", 10))
labl_4.place(x=70, y=280)

entry_3 = Entry(base)  # Changed from entry_02 to entry_3
